...
def test_post_email_insert_image_success(get_headers, teardown_email, valid_email_payload):
    """
    ...
    response = EspoCRMRequest.post_json(url, headers, valid_email_payload)
...
@allure.feature('Email Insert Image')
@allure.story('Post Email Insert Image')
def test_post_email_insert_image_ensure_all_data_in_response(get_headers, email_insert_image_payload):
    """
