...
class PayloadPaths:
    EMAIL_DRAFT_SUCCESS = BASE / 'core' / 'payloads' / 'mail_draft' / 'payload_email_draft_success.json'
    EMAIL_DRAFT_INVALID_EMAIL_FORMAT = BASE / 'core' / 'payloads' / 'mail_draft' / 'payload_email_draft_invalid_email_format.json'
